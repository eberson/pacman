...
class PacMan extends SimplePlayer with BlockMovementCollision, CustomMovementByJoystick {
  ...
  PacMan({required super.position})
      : super(
          ...
          animation: PacManSpriteSheet.pacManAnimation,
          speed: 100,
        );
  ...
  bool onBlockMovement(Set<Vector2> intersectionPoints, GameComponent other) {
    ...
    if (other is Dot || other is DotPower || (other is Ghost && other.state != GhostState.normal)) {
      return false;
    }
  ...
  void _handleContact(GameComponent component) {
    if (component is Dot && !component.eaten) {
      component.eaten = true;
      eatDot();
